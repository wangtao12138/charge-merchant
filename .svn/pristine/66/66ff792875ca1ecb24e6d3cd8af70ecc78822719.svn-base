...
public class MerchantPropertyServiceImpl implements MerchantPropertyService {
    ...
    @Override
    @Transactional
    public void addProperty(MerchantPropertyVo merchantPropertyVo) throws BusinessException{
    ...
    @Override
    @Transactional
    public void updateProperty(MerchantPropertyVo merchantPropertyVo) throws BusinessException{
        //判断修改物业名称是否重复

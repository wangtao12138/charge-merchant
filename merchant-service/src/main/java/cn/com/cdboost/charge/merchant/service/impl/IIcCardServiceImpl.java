...
public class IIcCardServiceImpl extends BaseServiceImpl<Card> implements IIcCardService{
    ...
    public PageData<IcCardListDto> queryIcList(IcCardParam param) {
        ...
        if (!StringUtils.isEmpty(param.getCustomerGuid())){
        ...
        if(!StringUtils.isEmpty(param.getSortName())&&!StringUtils.isEmpty(param.getSortOrder())){
            PageHelper.startPage(param.getPageNumber(),param.getPageSize(), param.getSortName()+" "+param.getSortOrder());
        }else {
